...
void render_final_scene(int image_width, int samples_per_pixel, int max_depth) {
...
int main() 
{
    ...
    // render_earth();
    // render_perlin_spheres();
    // render_quads();
    // render_simple_light();
    // render_cornell_box();
    // render_cornell_smoke();
    render_final_scene(400, 250, 4);
}